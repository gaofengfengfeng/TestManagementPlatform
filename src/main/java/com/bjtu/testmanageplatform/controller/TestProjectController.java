...
public class TestProjectController {
    ...
    public CreateProjectResponse create(HttpServletRequest request,
        ...
        JLog.info(String.format("create project name={}", createProjectData.getName()));
    ...
    public JResponse changeStatus(HttpServletRequest request,
        ...
        JLog.info(String.format("change project status prokectId={} new status={}",
    ...
    public JResponse assignTester(HttpServletRequest request,
        ...
        JLog.info(String.format("assignTester projectId={}", assignTesterData.getProject_id()));
        JResponse jResponse = new JResponse();
    ...
    public ProjectListResponse list(HttpServletRequest request,
        ...
        JLog.info(String.format("project list userId={}", userProfile.getUser_id()));
    ...
    public TemplateResponse template(HttpServletRequest request,
        ...
        JLog.info(String.format("template projectId={}", templateData.getProject_id()));
